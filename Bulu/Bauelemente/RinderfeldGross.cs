...
{
    class RinderfeldGross : Bauelement
    {
        public RinderfeldGross()
        {
            BildungspunkteProPersonProRunde = 0;
            NahrungspunkteProPersonProRunde = 3;
            ...
            Grafik = loadImageFromFile("bilder\\rinderfeldgross.png");
            Text = "Großes Rinderfeld";
            Description = "Landwirtschaftlich für Rinder genutztes, großes Feld.";
            VerfuegbarAbLevelIndex = 1;
            MaximumFieldAmount = 0;
            Identifier = "RinderfeldGross";
        }
    }
}
